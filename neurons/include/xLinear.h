...
extern "C"
{
   ...
   * @return Pointer to allocated matrix. NULL if allocation fails or invalid dimensions.
   */
   ...
   * @return Pointer to identity matrix. NULL if allocation fails or invalid dimension.
   */
   ...
   *
   * @warning Result matrix can not have same pointer as input matrices (due to in-place
   * operations).
   *
   * @note Does nothing if any matrix is NULL or dimensions are invalid.
   */
   ...
   * @param scale Scalar value to scale second row by before adding to first row (does not affect
   * second row values).
   *
   ...
   * @param scale Scalar value to scale second column by before adding to first column (does not
   * affect second column values).
   *
   * @note Does nothing if index is out of bounds or matrix is NULL.
   */
